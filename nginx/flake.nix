{
  ...
  outputs = { self, nixpkgs }:
    let
      ...
      domain_2 = "ryuora158sb.duckdns.org";
    in
    {
        ...
        text = ''
	      ...
	      return 301 https://''$host''$request_uri;
            ...
            server {
              listen 443 ssl;
              listen [::]:443 ssl;
	      server_name ryuora158sb.duckdns.org;

              ssl_certificate /etc/letsencrypt/live/ryuora158sb.duckdns.org/fullchain.pem;
              ssl_certificate_key /etc/letsencrypt/live/ryuora158sb.duckdns.org/privkey.pem;
		...
		# 2. Prevent Nginx from compressing the response before filtering
	      ...
	      client_max_body_size 2G;
              client_body_buffer_size 128k;
               ...
               location ^~ /syncthing/ {
               # 1. Strip the "/syncthing" prefix before sending it to the backend
	      ...
	      # Catch the bare URL and force the slash
              location = /syncthing {
